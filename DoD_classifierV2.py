...
class MetacognitiveTrainingGenerator:
    ...
    def __init__(self,
        ...
        try:
            ...
            self.logger.info("Successfully configured Google Generative AI with Gemini 1.5 Flash model.")
        except Exception as e:
            self.logger.error(f"Failed to configure Google Generative AI: {e}")
            raise
    ...
    def send_to_model(self, prompt: str, **kwargs) -> str:
        """
